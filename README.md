...
[![CRAN status](https://www.r-pkg.org/badges/version/ssBartik)](https://CRAN.R-project.org/package=ssBartik)
...
> **NOTE**: When the version on CRAN is not the latest, install from GitHub directly, or through R-universe for the latest version.
